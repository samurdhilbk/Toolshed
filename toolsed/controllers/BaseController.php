...
class BaseController {
    ...
    /**
     * @var ToolsEd The ToolsEd framework application to inject into this controller.
     */
    protected $_app =         null;
     ...
     * ToolsEd needs to connect to the database for just about every request.
     * Request type: GET
     */
