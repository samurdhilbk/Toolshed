 ...
 * DO NOT CHANGE!  This is a core ToolsEd file, and should not need to be changed by developers.
 * 
 * @package ToolsEd
 * @author Samurdhi Karunarathne
 * @see http://www.toolsed.com/components/#authentication
 */
    ...
    public function leaveNode(Node $node) {
        ...
        if ($node instanceof PhpParser\Node\Expr\FuncCall) {
            ...
            try{
                ...
                throw new ToolsEd\AuthorizationException("Authorization failed: Access condition method '$method' does not exist.");
            }         
    ...
    private function resolveParamPath($path){
        ...
        foreach ($pathTokens as $token){
            ...
            if (is_array($value) && isset($value[$token])){
                ...
                throw new ToolsEd\AuthorizationException("Cannot resolve the path \"$path\".  Error at token \"$token\".");
            }
        }
        return $value;
    }
